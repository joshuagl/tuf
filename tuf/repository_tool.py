...
def _get_hash(target_filepath):
  """
  <Purpose>
    Generate a hash of target_filepath using HASH_FUNCTION

  <Arguments>
    target_filepath:
      A path to a targetfile, relative to the targets directory, to hash

  <Returns>
    The hash of target_filepath as a string.
  """
